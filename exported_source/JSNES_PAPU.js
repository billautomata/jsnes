...
this.updateChannelEnable = function(value){
...
this.clockFrameCounter = function(nCycles){
...
this.accSample = function(cycles) {
...
this.frameCounterTick = function(){
...
this.getLengthMax = function(value){
        return this.lengthLookup[value >> 3];
    }
this.getDmcFrequency = function(value){
        if (value >= 0 && value < 0x10) {
            return this.dmcFreqLookup[value];
        }
        return 0;
    }
this.getNoiseWaveLength = function(value){
        if (value >= 0 && value < 0x10) {
            return this.noiseWavelengthLookup[value];
        }
        return 0;
    }
this.setPanning = function(pos){
        for (var i = 0; i < 5; i++) {
...
this.initLengthLookup = function(){
...
this.initDmcFrequencyLookup = function(){
...
this.initNoiseWavelengthLookup = function(){
